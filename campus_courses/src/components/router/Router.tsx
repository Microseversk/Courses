...
const TeachingCoursesPage = lazy(
	() => import('../pages/teachingCoursesPage/TeachingCoursesPage')
)
	...
	return (
		...
		>
			<Routes>
				<Route
					path='/'
					element={<PrivateLayout children={<GreetingPage />} />}
				/>
				<Route
					path='/groups'
					element={<PrivateLayout children={<GroupsPage />} />}
				/>
				<Route
					path='/groups/:id'
					element={<PrivateLayout children={<GroupCoursesPage />} />}
				/>
				<Route
					path='/courses/my'
					element={<PrivateLayout children={<MyCoursesPage />} />}
				/>
				<Route
					path='/courses/teaching'
					element={<PrivateLayout children={<TeachingCoursesPage />} />}
				/>
				<Route
					path='/courses/:id'
					element={<PrivateLayout children={<CourseDetailsPage />} />}
				/>
				<Route
					path='/profile'
				...
				<Route
					path='/registration'
					element={<PublicLayout children={<RegistrationPage />} />}
				/>
